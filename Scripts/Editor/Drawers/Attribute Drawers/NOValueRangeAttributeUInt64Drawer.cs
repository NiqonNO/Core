...
{
    public class NOValueRangeAttributeUInt64Drawer<T1, T2> : OdinAttributeDrawer<NOValueRangeAttribute, T1> where T1 : NOValueBase<ulong, T2> where T2 : NOValueAsset<ulong>
    {
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            else NOEditorDrawerUtility.DrawSlider((IPropertyValueEntry<ulong>)LocalValueProperty.ValueEntry, Attribute.MinValue, Attribute.MaxValue);
