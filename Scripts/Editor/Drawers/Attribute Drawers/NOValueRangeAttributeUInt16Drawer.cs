...
{
    public class NOValueRangeAttributeUnt16Drawer<T1, T2> : OdinAttributeDrawer<NOValueRangeAttribute, T1> where T1 : NOValueBase<ushort, T2> where T2 : NOValueAsset<ushort>
    {
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            else NOEditorDrawerUtility.DrawSlider((IPropertyValueEntry<ushort>)LocalValueProperty.ValueEntry, Attribute.MinValue, Attribute.MaxValue);
