...
{
    public class NOValueMinAttributeDrawer<T, T1, T2> : OdinAttributeDrawer<NOValueMinAttribute, T1> where T1 : NOValueBase<T, T2> where T2 : NOValueAsset<T> where T : struct
    {
