...
{
    public class NOValueRangeAttributeSByteDrawer<T1, T2> : OdinAttributeDrawer<NOValueRangeAttribute, T1> where T1 : NOValueBase<sbyte, T2> where T2 : NOValueAsset<sbyte>
    {
